...
/** @internal */
export const FridaDeviceTypeId: unique symbol = Symbol.for("@shocae/control/Frida/FridaDevice") as FridaDeviceTypeId;
...
/** @internal */
export const FridaDevice = Context.GenericTag<FridaDevice>("@shocae/control/Frida/FridaDevice");
